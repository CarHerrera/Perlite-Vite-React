    ...
    <div class="titlebar">
        <div class="titlebar-inner">
            <div class="titlebar-button-container mod-left">
                <div class="titlebar-button mod-logo"><svg viewBox="0 0 100 100" width="18" height="18"
                        class="logo-full">
                        <defs>
                    ...
                    </svg><svg viewBox="0 0 100 100" width="18" height="18" fill="none" stroke="currentColor"
                                ...
                                <div class="workspace-leaf-content" data-type="backlink">
                                    ...
                                    <div class="view-content">
                                        ...
                                        <div class="backlink-pane node-insert-event" style="position: relative;">
                                            ...
                                            <div id="tags_container" class="outline" style="display: block">
                                                <div class="sidebar-top">
                                                    <h3>Tags</h3>
                                                </div>
